...
elegans_options="-maxel 8000 -reglen 0.5 -maxic 10000 -minic 20 -maxin 50000 -mm 0 -exm 3 -indt 100 -exd 10 -tf 1.0 -inscf 3 -excut 3 -toff 50 -el 15"
gff_file=${base_dir}/genes-elegans-options.gff3
reg_file=${base_dir}/genes-elegans-options-regions-ss-reglen0.5.txt
